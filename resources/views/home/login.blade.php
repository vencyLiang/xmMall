...
<div id="main" class="layout">
                ...
                <form name="formLogin" action="/login" method="post">
                    ...
                    <div class="ng-foot clearfix">
                        ...
                        <div class="ng-link-area">
                            <span><a href="{{route('password.request')}}">忘记密码?</a></span>
    ...
    <div class="nl-footer">
        <div class="nl-f-nav">
            <p class="nl-f-copyright">©<a href="{{route('home')}}">mi.com</a> 京ICP证110507号 京ICP备10046444号 京公网安备1101080212535号 <a href="http://mm.com/user.php#">京网文[2014]0059-0009号</a></p>
        </div>
    </div>
