...
<div class="register_wrap">
    ...
    <div class="n-footer">
        ...
        <p class="nf-intro"><span>&copy;<a href="{{route('home.register')}}">mi.com</a> 京ICP证110507号 京ICP备10046444号 京公网安备1101080212535号 <a href="http://mm.com/user.php?act=register#">京网文[2014]0059-0009号</a></span></p>
    </div>
</div>
